...
document.addEventListener('DOMContentLoaded', function () {
    ...
    sizesButtons.forEach(button => {
        button.addEventListener('click', function (event) {
            ...
            // Find the corresponding Colors link in the navigation and simulate a click
            const colorsNavLink = document.querySelector('.navigation .list:nth-child(3)'); // Assuming Colors is the third item
            colorsNavLink.click();
        });
    });
});
